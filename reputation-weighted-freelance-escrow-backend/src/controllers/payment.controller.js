...
const ESCROW_ADDRESS = getEnvVar("ESCROW_CONTRACT_ADDRESS") || getEnvVar("ESCROW_ADDRESS", "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512");
const ADMIN_PRIVATE_KEY = getEnvVar("ADMIN_PRIVATE_KEY");
const RPC_URL = getEnvVar("BLOCKCHAIN_RPC_URL") || getEnvVar("RPC_URL", "http://127.0.0.1:8545");
 ...
 */
export const payUpi = async (req, res) => {
  req.body.amountInUSDC = req.body.usdcAmount;
  return createEscrow(req, res);
};
 ...
 */
export const webhookUpi = async (req, res) => {
  try {
